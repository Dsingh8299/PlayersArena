...
public class RoomIdPassActivity extends AppCompatActivity {
    WebView webView;
    DrawerLayout drawerLayout;
    private AdView mAdView,madView2;
    private String url = "https://apptoors.000webhostapp.com/RoomIdPass.html";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_room_id_pass);
        ...
        mAdView = findViewById(R.id.infoBanner1);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);
        madView2 = findViewById(R.id.infoBanner2);
    ...
    {
        startActivity(new Intent(RoomIdPassActivity.this,Home.class));
    }
