...
public class Winner extends AppCompatActivity {
    private String url = "https://apptoors.000webhostapp.com/Winner.html";
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdView = findViewById(R.id.WinnerBanner1);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);
        madView2 = findViewById(R.id.WinnerBanner2);
    ...
    {
        startActivity(new Intent(Winner.this,Home.class));
    }
